...
public class CustomerDetails {
    ...
    @Schema(title = "documentType", example = "DNI o Passport", description = "Customer document type identifier.")
    // private DocumentType documentType;
    private String documentType;

    @Schema(title = "documentNumber", example = "1234567891", description = "Customer document number.")
    @NotEmpty(message = NOTEMPTY_MESSAGE) // is both
